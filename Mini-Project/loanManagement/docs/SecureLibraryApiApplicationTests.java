Here is the unified, complete integration test class custom-built for the **Library Management API** domain.

It maps directly to the **17 test cases** from the banking suite, using your exact structural package layout (`org.northernarc.assessment4`), modern standard `ObjectMapper` imports, and handles everything down to the complex JPQL aggregate expectations.
...
import org.northernarc.assessment4.repository.BookRepository;
import org.northernarc.assessment4.repository.MemberRepository;
import org.northernarc.assessment4.repository.IssueRecordRepository;
import org.northernarc.assessment4.repository.FineTransactionRepository;
...
public class SecureLibraryApiApplicationTests {
    ...
    void setUpData() {
        ...
        testMember.setPassword("$2a$10$7R9X..."); // Mock hashed password
