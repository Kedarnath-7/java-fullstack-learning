...
public class BookDaoImpl implements BookDao {
    ...
    public List<Book> sortByTitle() {
        ...
        return this.books.stream().sorted(Comparator.comparing(Book::getTitle).thenComparing(Book::getAuthor)).toList();
    }

    @Override
    public List<Book> sortByAuthor() {
        return this.books.stream().sorted(Comparator.comparing(Book::getAuthor).thenComparing(Book::getTitle)).toList();
    }
}
