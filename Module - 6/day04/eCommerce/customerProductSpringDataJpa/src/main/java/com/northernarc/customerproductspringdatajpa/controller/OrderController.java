...
//    }
    ...
    @GetMapping("/my")
    public ResponseEntity<List<OrderResponseDTO>> getMyOrders(@AuthenticationPrincipal CustomerPrincipal principal) {
        return ResponseEntity.ok(orderService.findMyOrders(principal.getId()));
    }
