...
public class CustomerServiceImpl implements CustomerService{
    ...
    public CustomerServiceImpl(CustomerRepository customerRepository, OrderRepository orderRepository, ProductRepository productRepository, PasswordEncoder passwordEncoder){
    ...
    public CustomerResponseDTO addCustomer(CustomerRequestDTO customer) {
        ...
        customer1.setRole(CustomerRole.USER);
