...
engine = create_engine(
     "postgresql://postgres:12345@localhost:5432/northerarc"
 )
...
#Update
existingDomain = session.query(Scan).filter_by(id = 1).first()
...
#Delete 
duplicateDomainName = session.query(Scan).filter_by(id = 2).first()
